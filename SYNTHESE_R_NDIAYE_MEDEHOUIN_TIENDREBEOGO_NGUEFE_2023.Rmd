...
author: "Par:Jean Pierre Adiouma NDIAYE - Stewart NGUEFE - P. TIENDREBEOGO - Crépin MEDEHOUIN"
date: "Juillet 2023"
output:
...
D'accord! Nous savons grace aux packages Janitor et gtsummary comment avoir des tableaux statistiques de qualité. Mais comment mettre ces tableaux dans un document Word ou Pdf? R markdown est une partie de R concut pour repondre aux limites de gtsummary en se qui concerne la production des documents sur et des rapports sur R.
...
Dans le package tidytext, la fonction unnest_tokens est essentielle car elle permet de découper des textes en jetons pour un meilleur traitement. Dplyr permet une manipulation plus aisée des données par des fonctions telles que : filter,count,mutate etc.Le package tm par ces fonctions tm_map servent à gérerles textes.On peut rétirer les ponctuations, les nombres, les mots en anglais etc.
